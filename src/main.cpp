...
#include "ui.h"
#include "app_theme.h"
#include "theme_manager.h" // selects and loads the active theme, with the built-in default as the fallback
...
void setup() {
    ...
    theme_manager::init(); // resolve the effective theme through the manager and load its runtime data
    ...
    theme_manager::ensureDefaultBaked();
