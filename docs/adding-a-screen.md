...
- [ ] The default theme is regenerated (`python3 tools/gen_default_theme.py`) and
      `tests/test_default_theme.py` passes: a brand new theme must look identical to what
...
| Default theme | `src/theme_assets/default/theme.yaml`, generated by `tools/gen_default_theme.py` |
